...
export default function ConversationSettings({ route, navigation }) {
  ...
  const { username, status } = route.params.userInfo;

  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity activeOpacity={.5} onPress={() => navigation.navigate("Chat")}>
      ...
      <ScrollView>
        ...
        <View style={styles.actions}>
          <TouchableOpacity activeOpacity={.5} style={styles.actions_content}>
        ...
        <View style={styles.settingList}>
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
            <Text style={styles.settingList_item_text}>Color</Text>
            <Ionicons name="md-heart-circle" style={styles.settingList_item_icon} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
          ...
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
            ...
            <Entypo name="chevron-right" style={styles.settingList_item_icon_2} />
          </TouchableOpacity>
          ...
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
            <Text style={styles.settingList_item_text}>Search in Conversation</Text>
            <Entypo name="magnifying-glass" style={styles.settingList_item_icon_2} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
            <Text style={styles.settingList_item_text}>Create group</Text>
            <Ionicons name="people-sharp" style={styles.settingList_item_icon_2} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
          ...
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
            ...
            <MaterialCommunityIcons name="message-bulleted-off" style={styles.settingList_item_icon_2} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={.5} style={styles.settingList_item}>
